...
text = (
    f"Hola {nombre},\n\n"
    "Hace un tiempo dejaste tu contacto porque te interesaba Producción Musical Iniciación. "
    "Para que puedas hacerte una idea real de cómo son las clases y de mi forma de enseñar, "
    "grabé este vídeo para ti:\n\n"
    ...
    "La próxima convocatoria empieza la semana del 5 de octubre. Si quieres apuntarte:\n"
