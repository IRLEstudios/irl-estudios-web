...
text = (
    ...
    "sobre mi método de aprendizaje y un pequeño adelanto haciendo un beat:\n\n"
    ...
    "La próxima convocatoria empieza la semana del 5 de octubre. Si quieres apuntarte, aquí tienes el link directo de inscripción:\n"
